...
class Student:
    def __init__(self,root):
        ...
        # first img
        img = Image.open('./images/studen1.jpg')
        ...
        title_label = Label(bg_label, text='STUDENT MANAGEMENT SYSTEM',
        ...
        current_course_frame.place(x=7, y=135, width=715, height=115)
        ...
        class_Student_frame = LabelFrame(Left_frame, bd=2, bg='white', relief=RIDGE, text='Class student information',
                                          font=('times new roman', 12, 'bold'))
        class_Student_frame.place(x=7, y=250, width=715, height=300)
        ...
        radioBtn_1 = ttk.Radiobutton(class_Student_frame,variable=self.var_radio_1,text='Take Photo Sample',value='Yes')
        radioBtn_1.grid(row=6,column=0)

        radioBtn_2 = ttk.Radiobutton(class_Student_frame,variable=self.var_radio_1, text='No Photo Sample', value='No')
        radioBtn_2.grid(row=6, column=1)

        #buttons frame
        btn_frame = Frame(class_Student_frame,bd=2,relief=RIDGE,bg='white')
        btn_frame.place(x=7,y=205,width=695,height=35)
        ...
        btn_frame_1.place(x=7, y=240, width=695, height=35)
        take_photo_btn = Button(btn_frame_1,command=self.generate_dataset, text='Take Photo Sample', width=37, font=('times new roman', 12, 'bold'), bg='blue',
                           fg='white')
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn = Button(btn_frame_1, text='Update Photo Sample', width=37, font=('times new roman', 12, 'bold'),
                                bg='blue',
                                fg='white')
        ...
        img_right = Image.open('./images/right_photo.jpg')
        ...
        table_frame.place(x=7, y=210, width=710, height=350)
    ...
    def add_data(self):
        if self.var_dep.get()=='Select Department' or self.var_std_name.get()=='' or self.var_std_id.get()=='':
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='27032001',database='face_recognizer')
    ...
    def delete_data(self):
        if self.var_std_id.get()=='':
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo('DELETE','Successfully deletedstudent details',parent=self.root)
            except Exception as es:
                messagebox.showerror('ERROR',f'Due to:{str(es)}',parent=self.root)
