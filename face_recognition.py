...
class Face_Recognition:
    def __init__(self,root):
        ...
        #1st image
        img_top = Image.open('./images/facerecognition.jpg')
        ...
        #2nd image
        img_bottom = Image.open('./images/facerecognition2.jpg')
        ...
        # button
        btn_1_1 = Button(f_label,command=self.face_recog, text='Face Recognition', cursor='hand2',
                         font=('times new roman', 18, 'bold'), bg='darkgreen', fg='white')
        btn_1_1.place(x=365, y=620, width=200, height=40)

    # =============== attendance ===============================
    def mark_attendance(self,i,r,n,d):
        with open('mark_attendance.csv','r+',newline='\n') as f:
